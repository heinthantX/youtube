                      ...
                      <div className="w-full flex justify-end">
                        ...
                        <div className="w-5/6 flex h-fit">
                          <input
                            id="search"
                            name="search"
                            className="block w-full rounded-md border-[0.5px] border-gray-900 bg-black py-2 text-sm placeholder-gray-500 focus:border-gra focus:text-gray-600 focus:placeholder-gray-400 focus:outline-none focus:ring-1 focus:ring-blue-400 sm:text-sm"
                            placeholder="Search"
                            type="search"
                          />
                          <div className="pointer-events-none w-14 bg-[#313131] flex items-center justify-center">
                            <MagnifyingGlassIcon
        ...
        <div className=" pl-8">
          <div className="flex gap-8 w-full">
            <div className="w-52 mt-4">
              <nav
                aria-label="Sidebar"
                className="fixed divide-y w-44 divide-gray-300"
              >
