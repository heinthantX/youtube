...
const navigation = [
  ...
  { name: 'Shorts', href: '#', icon: CameraIcon, current: false },
  {
    name: 'Subscriptions',
    href: '#',
    icon: HeartIcon,
...
const Header = ({ searchClickListener }) => {
  return (
    <Popover
      as="header"
      className={({ open }) =>
        classNames(
          ...
          'bg-white shadow-sm sticky inset-0 z-20'
        )
      }
    >
      {({ open }) => (
        <>
          <div className="px-8 text-gray-50 bg-[#202020]">
            <div className="relative flex justify-between lg:gap-8 xl:grid xl:grid-cols-12">
              <div className="flex md:absolute md:inset-y-0 md:left-0 lg:static xl:col-span-2">
                <div className="flex flex-shrink-0 items-center gap-5">
                  <a href="#">
                    <span>
                      <svg
                        ...
                        focusable="false"
                        className="style-scope yt-icon pointer-events-none block h-7 fill-white"
                      >
                  ...
                  <a href="#">
                    <svg
                      className="block h-7 pointer-events-none fill-white style-scope yt-icon"
                      viewBox="0 0 90 20"
                      preserveAspectRatio="xMidYMid meet"
                      focusable="false"
                    >
              ...
              <div className="min-w-0 flex-1 md:px-8 lg:px-0 xl:col-span-6">
                <div className="flex items-center px-6 py-4 md:mx-auto md:max-w-3xl lg:mx-0 lg:max-w-none xl:px-0">
                  <Input searchClickListener={searchClickListener} />
                </div>
              </div>
              ...
              <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
                ...
                >
                  <svg
                    ...
                    preserveAspectRatio="xMidYMid meet"
                    focusable="false"
                    className="style-scope yt-icon pointer-events-none block h-8 fill-white"
                  >
                    <g className="style-scope yt-icon">
                      <path
          ...
          <Popover.Panel as="nav" className="lg:hidden" aria-label="Global">
            <div className="mx-auto space-y-1 px-2 pt-2 pb-3 sm:px-4">
              {navigation.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
